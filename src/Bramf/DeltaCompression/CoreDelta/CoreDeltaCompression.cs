...
{
    /// <summary>
    /// Provides methods to create DELTA files using re-made methods
    /// </summary>
    internal class CoreDeltaCompression
    {
        #region Private Members

        internal static ushort NHASH = 16;
        ...
        /// <summary>
        /// Creates a delta difference between two <see cref="byte"/> arrays
        /// </summary>
        /// <param name="origin">The origin byte array</param>
        /// <param name="target">The target byte array</param>
        internal static byte[] Create(byte[] origin, byte[] target)
        {
        ...
        /// <summary>
        /// Applies a delta to a <see cref="byte"/> array
        /// </summary>
        /// <param name="origin">The origin byte array</param>
        /// <param name="delta">The delta byte array</param>
        internal static byte[] Apply(byte[] origin, byte[] delta)
        {
            uint limit, total = 0;
            ...
            while (zDelta.HaveBytes())
            {
                ...
                switch (zDelta.GetChar())
                {
                    ...
                    case ':':
                        ...
                        zOut.PutArray(zDelta.ByteArray, (int)zDelta.CurrentPosition, (int)(zDelta.CurrentPosition + cnt));
                        zDelta.CurrentPosition += cnt;
                        break;
        ...
        /// <summary>
        /// Returns the size of target for this delta
        /// </summary>
        /// <param name="delta">The delta byte array</param>
